...
@router.get('/api/yelp')
def get_yelp(location: str, budget: int, open_at: datetime, categories: str, repo: YelpQueries = Depends()):
    ...
    return repo.get_yelp(location, budget, int(convertedDate), categories)
