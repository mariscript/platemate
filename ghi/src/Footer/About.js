            ...
            <div className="mb-24 md:mb-0">
              <div className="rounded-lg shadow-2xl h-full block bg-[#D9D9D9] border-2 border-black">
                ...
                <div className="p-6">
                  ...
                  <p className="mb-6">
                    "I'm Zac. My journey in programming started in early 2022.
                    My favorite part about working on this app, besides the
                    friendships we built along the way (apologies for the
                    cheese, pun intended), was working on the databases and
                    completing the backend functionality. My favorite food is
                    crab legs. "
                  </p>
